...
HISTORY_FIELDS = ["video_id", "title", "url", "status", "output_path", "error", "timestamp"]
...
class DownloadHistory:
    ...
    def _load_existing(self) -> None:
        ...
        logger.debug("Loaded %d previously completed video(s) from history", len(self._completed_ids))
